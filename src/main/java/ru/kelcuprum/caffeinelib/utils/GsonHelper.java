...
public class GsonHelper {
    ...
    public static JsonObject parseObject(String string) {
        return (JsonObject) parse(string, false);
    }
    public static JsonObject parseObject(String string, boolean bl) {
        return (JsonObject) parse(string, bl);
    }
    public static JsonObject parseObject(Reader reader, boolean bl) {
        return (JsonObject) parse(reader, bl);
    }

    public static JsonElement parse(String string) {
        return parse(string, false);
    }
    public static JsonElement parse(String string, boolean bl) {
        return parse((Reader)(new StringReader(string)), bl);
    }
    public static JsonElement parse(Reader reader, boolean bl) {
        return fromJson(GSON, reader, JsonElement.class, bl);
    }
